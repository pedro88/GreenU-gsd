...
test.describe('M001: Garden Cultivation — S02 Garden Data Model', () => {
  ...
  async function signInAndCreateGarden(page: any, gardenName: string = 'Test Garden'): Promise<string | null> {
    // Sign in
  ...
  test.describe('Crop Management', () => {
    test('should add a crop to a plot', async ({ page }) => {
      ...
      const addCropBtn = page.locator('button').filter({ hasText: /crop|plant/i }).first();
  ...
  test.describe('Garden Access Control', () => {
    test('should not allow viewer to edit garden', async ({ page }) => {
